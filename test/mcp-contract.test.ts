...
const required=['get_site_status','find_content_opportunities','find_question_opportunities','get_page_context','get_page_segments','get_page_lifecycle','get_query_entry_exit','get_measurement_readiness','get_repository_context','get_internal_link_context','review_local_actions','record_local_action'];
